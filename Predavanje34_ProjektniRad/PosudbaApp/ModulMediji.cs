...
namespace PosudbaApp
{
    internal class ModulMediji
    {
        public static void Read()
        {
            ...
            var mediji = DbMethods.DohvatiKolekcije;
            if (mediji != null)
            {
        ...
        public static void Update()
        {
            ...
            Console.WriteLine("ID\tNaslov medija\tTip medija");
            Console.WriteLine("--------------------------------");
            foreach (var m in DbMethods.DohvatiKolekcije())
            {
            ...
            DbMethods.IzmjeniKolekciju(medij);
            Console.WriteLine();
        ...
        public static void Delete()
        {
            ...
            DbMethods.ObrisiKolekciju(medijId);
            Console.WriteLine();
